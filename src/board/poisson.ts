...
// Ported from oskar-procedure src/poisson.js — algorithm and RNG consumption
// order preserved exactly (determinism: same seed => same points).
//
// The PRNG is INJECTED so results are reproducible by seed (no unseeded
// randomness anywhere). Returns an array of [x,y] points, inset from the
// boundary by ·0.85 + 0.075.
